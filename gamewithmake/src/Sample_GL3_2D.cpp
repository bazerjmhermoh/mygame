...
struct VAO *Buffer(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const GLfloat *color_buffer_data, GLenum fill_mode = GL_FILL)
{
...
struct VAO *create3DObject(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const GLfloat red, const GLfloat green, const GLfloat blue, GLenum fill_mode = GL_FILL)
{
    ...
    return Buffer(primitive_mode, numVertices, vertex_buffer_data, color_buffer_data, fill_mode);
}
...
void createTriangle()
{
    ...
    triangle = Buffer(GL_TRIANGLES, 3, vertex_buffer_data, color_buffer_data, GL_LINE);
}
...
void createRectangle()
{
    ...
    // create3DObject creates and returns a handle to a VAO that can be used later
    rectangle = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data, GL_FILL);
}
...
void createTurret()
{
    ...
    static const GLfloat color_buffer_data_hl[] = {
        // highlight
        0, 0, 0, // color 1
        0, 0, 0, // color 2
        0, 0, 0, // color 3
    ...
    // create3DObject creates and returns a handle to a VAO that can be used later
    turret = Buffer(GL_TRIANGLES, 12, vertex_buffer_data, color_buffer_data, GL_FILL);
    hlTurret = Buffer(GL_TRIANGLES, 12, vertex_buffer_data, color_buffer_data_hl, GL_LINE);
}
...
void createBuckets() // W: 1 | H: 0.6
{
    ...
    // create3DObject creates and returns a handle to a VAO that can be used later
    redBucket = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_red, GL_FILL);
    grnBucket = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_grn, GL_FILL);
    hlBucket = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_hl, GL_LINE);
}
...
void createBricks() // W: 0.2 | H: 0.3
{
    ...
    // create3DObject creates and returns a handle to a VAO that can be used later
    redBrick = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_red, GL_FILL);
    grnBrick = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_grn, GL_FILL);
    blkBrick = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data_blk, GL_FILL);
}
...
void createBullet() // W: 0.1 | H: 0.1
{
    ...
    // create3DObject creates and returns a handle to a VAO that can be used later
    bullet_vao = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data, GL_FILL);
}
...
void createMirror() // W: 0.02 | H: 0.7
{
    ...
    mirror = Buffer(GL_TRIANGLES, 6, vertex_buffer_data, color_buffer_data, GL_FILL);
}
